...
# Run simulations for combination countermeasure of Vanguards-lite and a token bucket
# in parallel with different adversarial parameters. The output must be redirected to
# a log file.
#
# Usage:
#    ./3_script_run-vanguards-lite-and-token-bucket.sh > results.log
#
